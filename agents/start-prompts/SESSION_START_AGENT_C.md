...
> 本窗口只服务 EVENT_AGENT_C。A/B/D/E 有各自独立的窗口和 worktree。
...
【隔离声明】本窗口只服务 EVENT_AGENT_C。其他 Agent 有各自独立的
...
`D:\研究生作业\人工智能实践比赛\山水智鉴_Git工作区\agent-c`，
或分支不是 `feature/agent-c-top-level-session`，立即停止。
